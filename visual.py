...
with col2:
    temp1_database = st.selectbox("Selecto your Database",("Chula 2018","Chula 2019","Chula 2020","Chula 2021","Chula 2022","Chula 2023","Arxiv"))
    if temp1_database:
        if temp1_database == 'Chula 2018':
            temp1_df = df1
        elif temp_database == 'Chula 2019':
            temp1_df = df2
        elif temp_database == 'Chula 2020':
        ...
        temp11_df = temp_df.groupby('').size().reset_index(name = "Article Count")
        col2.subheader()
